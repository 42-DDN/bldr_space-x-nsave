    ...
    return (
      <main className="min-h-screen flex flex-col items-center justify-center bg-gray-800 text-white p-4">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <a href="/lesson/1" className="bg-purple-600 px-6 py-4 rounded-lg text-lg font-semibold hover:bg-purple-700">
            📈 Lesson 1: Basics of Investing
          </a>
          <a href="/lesson/2" className="bg-green-600 px-6 py-4 rounded-lg text-lg font-semibold hover:bg-green-700">
