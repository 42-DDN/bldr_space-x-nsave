...
export default function LessonPage() {
  ...
  const clickableRegions = [
    [20, 60, 80, 70], // Step 1: "Sign Up" button region
    [30, 40, 70, 50], // Step 2: "Enter Amount" field region
    [25, 80, 75, 90], // Step 3: "Invest Now" button region
    [40, 85, 60, 95], // Step 4: "Finish" button region
  ];
